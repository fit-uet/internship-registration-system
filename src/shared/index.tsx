...
export const DEFAULT_PLAN = `## KẾ HOẠCH TRIỂN KHAI HỌC PHẦN THỰC TẬP
...
### 5. Báo cáo nộp ở đâu và cần nộp những gì để hoàn thành học phần?
- **Nộp bản mềm:** Sinh viên nộp báo cáo (PDF, tối đa 10 MB) trực tiếp trên hệ thống trong thời gian mở nộp để GVHD chấm Điểm tiến độ (20%) và Điểm báo cáo (20%).
- **Trang nhận xét đánh giá:** Nếu thực tập tại doanh nghiệp, sinh viên in trang nhận xét trong mẫu báo cáo của Khoa để xin điểm, nhận xét, chữ ký của người hướng dẫn và dấu của công ty, sau đó nộp cho GVHD để nhập Điểm doanh nghiệp (60%).
