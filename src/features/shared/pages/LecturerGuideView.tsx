  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
        ...
        {user?.role === 'admin' && (
          <button onClick={() => navigate('/admin/lecturer-guide')} className="bg-[#0071e3] hover:bg-[#0077ed] text-white px-3.5 py-1.5 rounded-xl text-xs font-semibold shadow-sm transition-all flex items-center gap-1.5 whitespace-nowrap cursor-pointer active:scale-[0.98]">
